...
struct ExpertCard: View {
    ...
    var descriptionScrollEnabled: Bool = true
    var onTap: (() -> Void)? = nil
    ...
    var body: some View {
        ...
        .shadow(color: Color(DS.PaywallTint.primaryPaywall), radius: 10, x: 0, y: 0)
        .onTapGesture {
            if let onTap { onTap() }
        }
    }
    ...
    @ViewBuilder func aboutExpert() -> some View {
        VStack(alignment: .leading, spacing: 4){
            ...
            .allowsHitTesting(self.descriptionScrollEnabled)
        }
        .padding(.horizontal)
    }
    ...
    ScrollView {
        VStack(spacing: 30) {
            ExpertCard(
                ...
                frameSize: CGSize(width: 300, height: 250),
