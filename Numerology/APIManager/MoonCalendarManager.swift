...
class MoonCalendarManager {
    ...
    func getAfternoonMoonDay() -> Int {
        ...
        // let result = info.moonModels.max { $0.age < $1.age }?.age // т.к ?
        let result2 = info.moonModels[1].age // не очень
        print("🌕🌚 Afternoon is day is",result2)
        return result2
    }
    ...
    lazy var mockDate: Date = {
        makeDate(strDate: "2024-04-07 18:06:46 +0000")
    }()!
