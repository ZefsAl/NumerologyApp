...
//            myPrint("🟣1 numerologyImagesDataUpdated - Notification yourHrscpImages =", numerologyImages?.count as Any)
        }
    }
...
//            myPrint("🟣2 angelNumbersImagesDataUpdated - Notification angelNumbersImages =", angelNumbersImages?.count as Any)
        }
    }
