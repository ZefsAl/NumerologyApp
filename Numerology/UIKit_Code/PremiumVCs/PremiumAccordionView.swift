...
final class PremiumAccordionView: UIView {
    ...
    private lazy var infoHeight = self.premiumTextViewHost.view.heightAnchor.constraint(equalToConstant: infotHeightConstant)
    ...
    let sharedData = PremiumTextData()
    
    lazy var premiumTextViewHost: UIHostingController = {
        let contentView = PremiumTextView_SUI(sharedData: sharedData)
