...
class MoneyCalendarCV: UICollectionView, CustomCalendarCellDelagete {
...
extension MoneyCalendarCV {
    ...
    func requestMonth() {
        ...
        // Month
        HoroscopeManager.shared.getMonthHoroscope(zodiacSign: sign) { model in
