...
/*
 Создать логику доступа к приложению и контенту включая "Free trial 7 day"
 
 
 0. При входе в приложение проверить наличае подписки!
 
 1. Новый пользователь без подписки -> оформить Free trial 7 day -> или купить
 2. Транзакции нет или подписки нет -> открыть модал Paywall -> купить 
 3. Если нет
 
 
 

 Можно делать конфиг ячеек +
 
 Отдельный конфиг тайтла кнопки что бы было понятно
 Лоадер! 
