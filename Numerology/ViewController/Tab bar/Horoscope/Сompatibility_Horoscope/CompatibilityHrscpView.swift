...
class CompatibilityHrscpView: UIView, MMMHorizontalPickerDelegate {
    ...
    func horizontalPickerDidChangeCurrentItemIndex(_ picker: MMMHorizontalPicker) {
        ...
        // тут можно инфинити скрол прикрутить
        // через picker.currentItemIndex
        // и
        // pickerView.setCurrentItemIndex(sender.model.index, animated: true)
        // на сколько понял принцип дублирования элементов и свич без анимации на
        // 11-0-1-2....11-(12.тоесть.0)-(13.тоесть.1) итд
        
        // то есть 12 индексов рабочих + по 2 индекса фейк покраям для переключения
        // при picker.currentItemIndex == 12 свич на
