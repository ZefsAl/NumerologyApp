...
class NumerologyVC_2024_v2: UIViewController, RemoteOpenDelegate {
...
// MARK: setup UI
extension NumerologyVC_2024_v2 {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            angelNumbersCV.heightAnchor.constraint(equalToConstant: 160+50),
